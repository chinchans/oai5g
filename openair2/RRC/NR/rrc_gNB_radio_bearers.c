                   ...
                   int fiveQI)
{
  ...
  est_drb->cnAssociation.sdap_config.defaultDRB = drb_id == 1 ? true : false;
  ...
  for (int qos_flow_index = 0; qos_flow_index < 1; qos_flow_index++) { // TODO: update when iplementing multiple QoS per DRB
