...
```
cd cmake_targets
sudo ./ran_build/build/nr-uesoftmodem --band 66 -C 2152580000 --CO 40000000 -r 25 --numerology 0 --ssb 4 --sa --rfsim --rfsimulator.prop_delay 238.74 --ntn-koffset 478 --ntn-ta-common 477.48
```
