                   ...
                   unsigned char harq_pid)
{
  ...
  LATSEQ_P("U phy.CHest--phy.CHrbscacompllr", "::fm%u.sl%u.hqpid%u.nbantrx%u.rnti%u.rssidBm%d.wbcqitotdB%d", frame, slot, harq_pid, frame_parms->nb_antennas_rx, rel15_ul->rnti, gNB->ulsch[ulsch_id].ulsch_measurements.rx_rssi_dBm, gNB->ulsch[ulsch_id].ulsch_measurements.wideband_cqi_tot);
  if (slot == 19) {
