...
static void handle_sl_bch(module_id_t module_id,
                          ...
                          uint16_t rx_slss_id)
{
  ...
  nr_mac_rrc_data_ind_ue(mac->ue_id, 0, 0, frame_rx, slot_rx, 0, rx_slss_id, 0, NR_SBCCH_SL_BCH, (uint8_t *)sl_mib, len);
